<?php
/**
 * Simple database initialization for Heroku PostgreSQL
 */
...
try {
    ...
    ");
    echo "✓ data_jamaah table created\n";
    ...
    ");
    echo "✓ data_invoice table created\n";
    ...
    ");
    echo "✓ data_pembatalan table created\n";

    // Insert sample data
    $conn->exec("
        INSERT INTO data_paket (jenis_paket, currency, program_pilihan, tanggal_keberangkatan, base_price_quad, base_price_triple, base_price_double, hotel_medinah, hotel_makkah, additional_hotels, room_numbers, hcn) 
        VALUES
